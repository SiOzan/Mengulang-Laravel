                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" @error('name') is-invalid @enderror" name="name" value="{{ $user->name }}" required autofocus id="input49" placeholder="Masukan nama">
                        </div>
                    </div>
                    @error('name')
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            ...
                            <input type="email" class="form-control" @error('email') is-invalid @enderror" name="email" value="{{ $user->email }}" required id="input51" placeholder="Email">
                        </div>
                    </div>
                    @error('email')
                        <span class="invalid-feedback" role="alert">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            ...
                            <select class="form-select" name="is_admin" id="input53">
                                ...
                                <option value="1" {{$user->is_admin ? 'selected' : ''}}>Ya</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <div class="d-md-flex d-grid align-items-center gap-3">
                            <button type="submit" class="btn btn-grd-primary px-4">Edit</button>
